...
/**
 * The HibernateSessionRequestFilter starts a Hibernate session in the doFilter method, 
 * calls the other filters, and commits the Session at the end. 
 * As result, after every request, a hibernate session is created and ended. 
 */
