...
public class FacesUtils {
	...
	public static Object getBackingBean(String beanName) {
		...
		ValueExpression valueExpression = expressionFactory
				.createValueExpression(elContext, convertToElSyntax(beanName),
						Object.class);
	...
	public static manager.UserManager getUserManager() {
		return (manager.UserManager) FacesUtils.getManagedBean("userManager");
	}

	public static GroupManager getGroupManager() {
		return (GroupManager) FacesUtils.getManagedBean("groupManager");
	}

	public static SecurityController getSecurityController() {
		return (SecurityController) FacesUtils.getManagedBean("securityController");
		
	}

	public static MapViewController getMapViewController() {
		return (MapViewController) FacesUtils.getManagedBean("mapViewController");
